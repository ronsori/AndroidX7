package co.onsori.balasandroid;
...
import static co.onsori.balasandroid.R.id.text_view;
...
//        savedInstanceState.putBoolean("LED7", ((LEDControl)findViewById(R.id.led_7)).getState());
        ...
        savedInstanceState.putInt("POT", ((ProgressBar)findViewById(R.id.progress_bar1)).getProgress());
                            ...
                            while(true) {
                                ...
                                switch(commandPacket[0]) {
                                    case POT_STATUS_CHANGE:
                                        ...
                                        if((commandPacket[1] >= 0) && (commandPacket[1] <= progressBar1.getMax())) {
                                            progressBar1.setProgress(commandPacket[1]);
                                            progressBar2.setProgress(commandPacket[1]);
                                            String s = Integer.toString(commandPacket[1]);
                                            s = s + " Kg";
                                            TV.setText(s);
                                        }
                                        break;
